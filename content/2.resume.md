...
::arch-section{title="Resume" padding :cols="1" line icon="line-md:clipboard-list"}
  ...
  items:
    - title: Frontend Engineer
      company:
        text: Auctria
        link: https://auctria.com
      date:  2024-present
      location: Canada
      description: "My role supports maintaining and improving the platform's performance and user experience by fixing bugs, adding features, and migrating old code."
    ...
    - title: Mobile Application Developer
      ...
      location: Turkey
      description: "Designed and developed hybrid mobile applications and websites using Flutter and Laravel. Specialized in advanced state management and integrating Redux."
    - title: Full Stack Developer
      company:
        text: IMC Creative
      date:  2020-2022 | Full Time
      location: Turkey
      description: "Architected and implemented corporate and e-commerce websites. Focused on complex UI design, database optimization and scalable solutions."
    - title: Full Stack Web Developer / Animator
      company:
        text: Seventh-day Adventist Church - Experience of Salvation Ministry
      date:  2019-2021 | Contract
      location: Canada
      description: "Developed web apps with dynamic interfaces, created animations, and managed social media. Utilized Laravel, Vue.js, Node.js, Nuxt and more creative tools."
    - title: Web Developer
      company:
        text: İbrala Medya
      date:  2019-2021 | Full Time
      location: Turkey
      description: "Designed and developed corporate websites working with Vue.js and Laravel"
    - title: Animator
      company:
        text: Argemental
      date:  2018-2019 | Full Time
      location: Turkey
      description: "Designed captivating motion graphics and advertisements using After Effects and Cinema 4D, bringing a dynamic visual appeal to projects."
  ...
  items:
   - title: Computing Science
      company:
        text:  University of Alberta - Bachelor of Science
      date:  2024-2027
